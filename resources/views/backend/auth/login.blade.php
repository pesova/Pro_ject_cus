                        ...
                        <div class="container-fluid">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="tel" id="phone" name="" class="form-control"
                                                               value="" aria-describedby="helpPhone"
                                                               required>
                                                        <input type="hidden" name="phone_number" id="phone_number"
                                                               class="form-control">
                                                    </div>
                                                    <small id="helpPhone" class="form-text text-muted">Enter your phone number without the country code
                                                    </small>
                                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <p class="text-muted">Dont have an account? <a href="/app/register"
